...
const FigmaDesignBlock = () => {
    ...
    // Data fetching
    const {data: figmaDesignData} = useFetch("http://91.107.217.207/jsonapi/block_content/w_full_block/121c2905-1aad-4a35-b001-249f99f464e1?resourceVersion=id%3A4&include=field_image",
        "figmaDesign")
