...
const Header = ({isModalOpen, setIsModalOpen}) => {
    ...
    const {data: blogLogo} = useFetch("http://91.107.217.207/jsonapi/block_content/basic/d6ee7696-ee2d-47f1-a4ba-c6b6a2ac583c?resourceVersion=id%3A1&include=field_image",
        "blogLogo")
